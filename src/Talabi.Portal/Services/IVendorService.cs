...
{
    Task<PagedResult<VendorListDto>> GetVendorsAsync(int page, int pageSize, string? search, string? sortColumn,
    ...
    Task<bool> UpdateCommissionRateAsync(string id, decimal rate);
}
