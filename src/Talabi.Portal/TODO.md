...
- [x] Yeni Endpoint: `GET /api/vendor/reports/hourly-sales` (Saatlik satış yoğunluğu - Bugün için)
- [x] Büyüme Oranları: Geçen haftanın aynı gününe göre değişim yüzdeleri.

## 5. Aksiyon Kartları (Alerts & Insights)

- [x] Yeni Endpoint: `GET /api/vendor/dashboard/alerts`
- [x] İçerik:
  - [x] **Kritik Stok:** Stoğu azalan ürünler.
  - [x] **Geciken Siparişler:** Hazırlanma süresini aşan siparişler.
  - [x] **Cevaplanmayan Yorumlar:** Bekleyen yorum sayıları.
