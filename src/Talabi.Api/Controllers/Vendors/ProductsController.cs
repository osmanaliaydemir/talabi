...
/// <summary>
/// Vendor Dashboard - Ürün yönetimi için controller
/// </summary>
[Route("api/vendors/dashboard/products")]
[ApiController]
[Authorize]
    ...
    public async Task<ActionResult<ApiResponse<object>>> UpdateProduct(Guid id, UpdateProductDto dto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new ApiResponse<object>(
                LocalizationService.GetLocalizedString(ResourceName, "ProductUpdateFailed", CurrentCulture),
                "UPDATE_FAILED"));
        }
    }
