...
class $AssetsIconGen {
  ...
  /// File path: assets/icon/logo_backup.png
  AssetGenImage get logoBackup =>
      const AssetGenImage('assets/icon/logo_backup.png');

  /// List of all assets
  List<AssetGenImage> get values => [logo, logoBackup];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/icon-notif.png
  AssetGenImage get iconNotif =>
      const AssetGenImage('assets/images/icon-notif.png');

  /// File path: assets/images/location.png
  AssetGenImage get location =>
      const AssetGenImage('assets/images/location.png');

  /// File path: assets/images/market_banner.png
  AssetGenImage get marketBanner =>
      const AssetGenImage('assets/images/market_banner.png');

  /// File path: assets/images/onboarding1.png
  AssetGenImage get onboarding1 =>
      const AssetGenImage('assets/images/onboarding1.png');

  /// File path: assets/images/order_now_button.png
