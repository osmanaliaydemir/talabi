...
class MockApiService extends _i1.Mock implements _i8.ApiService {
  ...
  @override
  _i9.Future<void> clearCartPromotions() => (super.noSuchMethod(
        Invocation.method(
          #clearCartPromotions,
          [],
        ),
  ...
  @override
  _i9.Future<List<_i3.Product>> getRecommendations({
    int? type,
    double? lat,
    double? lon,
  }) =>
  ...
  @override
  _i9.Future<List<_i3.Product>> getCampaignProducts(String? campaignId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCampaignProducts,
          [campaignId],
  ...
  @override
  _i9.Future<bool> canReviewProduct(String? productId) => (super.noSuchMethod(
        Invocation.method(
          #canReviewProduct,
          [productId],
        ),
  ...
  @override
  _i9.Future<List<_i7.Review>> getUserReviews() => (super.noSuchMethod(
        Invocation.method(
          #getUserReviews,
          [],
        ),
  ...
  @override
  _i9.Future<_i7.Review> getReviewById(String? reviewId) => (super.noSuchMethod(
        Invocation.method(
          #getReviewById,
          [reviewId],
        ),
  ...
  @override
  _i9.Future<List<Map<String, dynamic>>> getHourlySales() =>
      (super.noSuchMethod(
        Invocation.method(
          #getHourlySales,
          [],
  ...
  @override
  _i9.Future<Map<String, dynamic>> getDashboardAlerts() => (super.noSuchMethod(
        Invocation.method(
          #getDashboardAlerts,
          [],
        ),
  ...
  @override
  _i9.Future<void> submitOrderFeedback(Map<String, dynamic>? data) =>
      (super.noSuchMethod(
        Invocation.method(
          #submitOrderFeedback,
          [data],
  ...
  @override
  _i9.Future<Map<String, dynamic>> getOrderReviewStatus(String? orderId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i9.Future<Map<String, dynamic>?> getUnreviewedOrder() => (super.noSuchMethod(
        Invocation.method(
          #getUnreviewedOrder,
          [],
        ),
  ...
  @override
  _i9.Future<String?> getSystemSetting(String? key) => (super.noSuchMethod(
        Invocation.method(
          #getSystemSetting,
          [key],
        ),
...
class MockNotificationProvider extends _i1.Mock
  ...
  @override
  List<_i13.CustomerNotification> get notifications => (super.noSuchMethod(
        Invocation.getter(#notifications),
        returnValue: <_i13.CustomerNotification>[],
        returnValueForMissingStub: <_i13.CustomerNotification>[],
      ) as List<_i13.CustomerNotification>);
  ...
  List<_i21.VendorNotification> get vendorNotifications => (super.noSuchMethod(
        ...
        returnValueForMissingStub: <_i21.VendorNotification>[],
  ...
  @override
  _i9.Future<void> loadNotifications() => (super.noSuchMethod(
        Invocation.method(
          #loadNotifications,
          [],
        ),
  ...
  @override
  _i9.Future<void> loadVendorNotifications({bool? force = false}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i9.Future<void> markAsRead(String? notificationId) => (super.noSuchMethod(
        Invocation.method(
          #markAsRead,
          [notificationId],
        ),
...
class MockCartProvider extends _i1.Mock implements _i23.CartProvider {
  ...
  @override
  _i9.Future<void> fetchRecommendations({
    int? type,
    double? lat,
    double? lon,
  }) =>
