...
class MockSyncService extends _i1.Mock implements _i16.SyncService {
  ...
  @override
  _i8.Future<void> removeFromQueue(String? actionId) => (super.noSuchMethod(
        Invocation.method(
          #removeFromQueue,
          [actionId],
        ),
  ...
  @override
  _i8.Future<int> getQueueSize() => (super.noSuchMethod(
        Invocation.method(
          #getQueueSize,
          [],
        ),
...
class MockConnectivityProvider extends _i1.Mock
  ...
  @override
  _i8.Future<void> checkConnectivity() => (super.noSuchMethod(
        Invocation.method(
          #checkConnectivity,
          [],
        ),
